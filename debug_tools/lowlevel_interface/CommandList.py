...
Command(0x8B, "Actuator Get Position", CommandType.SHORT_ORDER, [],
		[Field("y", float),
		 Field("z", float),
		 Field("theta", float)]),
Command(0x8C, "Actuator Set z speed", CommandType.SHORT_ORDER, [Field("Speed", int)], []),
Command(0x8D, "Actuator Set y speed", CommandType.SHORT_ORDER, [Field("Speed", int)], []),
Command(0x8E, "Actuator Set theta speed", CommandType.SHORT_ORDER, [Field("Speed", int)], []),
...
Command(0x9B, "Trajectory tunings",     CommandType.SHORT_ORDER, [Field("K1", float), Field("K2", float)], []),
